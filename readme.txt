...
Donate link: www.SaschaLabs.net/partner
...
= Donate =
Enjoy using *Flipwall*? Please consider [making a donation](http://www.SaschaLabs.net/partner/) to support the project's continued development.



== Installation ==

1. Upload `flipwall` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Click on the Flipwall link from the main menu
4. Check out the help by clicking the help icon and create your first package.

The Flipwall requires php 5.3 or higher.

== Frequently Asked Questions ==

= I'm having issues getting the plugin to work what should I do? =

See the [FAQs](http://www.SaschaLabs.net/flipwall-faq) page for a detailed rundown of common issues

= Are there any videos I can watch? =

Yes.  Please see the [tutorial section](http://www.SaschaLabs.net/flipwall-tutorials] on the user guide for videos.


= Where can I get more information and support for this plugin? =

Visit the [Flipwall Page](http://www.SaschaLabs.net/flipwall) at www.SaschaLabs.net


= Can I test this in a non-production environment? =

Yes. Put WordPress on [your computer](http://www.SaschaLabs.net/xampp) by watching the video below.
...
http://www.SaschaLabs.net/flipwall-log
