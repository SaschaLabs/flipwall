...
<div id="dup-wiz">
	<div id="dup-wiz-steps">
		...
		<div class="completed-step"><a><span>2</span> <?php _e('Scan', 'wpflipwall'); ?> </a></div>
		<div class="active-step"><a><span>3</span> <?php _e('Build', 'wpflipwall'); ?> </a></div>
	</div>
	<div id="dup-wiz-title">
		<?php _e('Step 3: Build Package', 'wpflipwall'); ?>
	</div> <hr/>
</div>

<form id="form-flipwall" method="post" action="?page=flipwall">

	<!--  PROGRESS BAR -->
	<div id="dup-progress-bar-area">
		<h2><i class="fa fa-cog fa-spin"></i> <?php _e('Building Package', 'wpflipwall'); ?></h2>
		<div id="dup-progress-bar"></div>
		<b><?php _e('Please Wait...', 'wpflipwall'); ?></b><br/><br/>
		<i><?php _e('Keep this window open during the build process.', 'wpflipwall'); ?></i><br/>
		<i><?php _e('This may take several minutes.', 'wpflipwall'); ?></i><br/>
	</div>
	
	<div id="dup-progress-area" class="dup-panel" style="display:none">
		<div class="dup-panel-title dup-box-title-fancy"><b style="font-size:18px"><?php _e('Build Status', 'wpflipwall'); ?></b></div>
		<div class="dup-panel-panel">
			...
			<div id="dup-msg-success" style="display:none">
				<div class="dup-hdr-success">
					<i class="fa fa-check-square-o fa-lg"></i> <?php _e('Package Completed', 'wpflipwall'); ?>
				</div>
				
				<div class="dup-msg-success-stats">
					<b><?php _e('Name', 'wpflipwall'); ?>:</b> <span id="data-name-hash"></span><br/>
					<b><?php _e('Process Time', 'wpflipwall'); ?>:</b> <span id="data-time"></span><br/>
				</div><br/>
				...
				<div class="dup-msg-success-links">
					<?php printf("<a href='?page=flipwall'>[ %s ]</a>", 	__('All Packages', 'wpflipwall'));?> 
					<?php //printf("<a href='?page=flipwall&tab=new1'>[ %s ]</a>", 	__('Create Another Package', 'wpflipwall'));?> 
				</div><br/>
			...
			<div id="dup-msg-error" style="display:none">
				<div class="done-title"><i class="fa fa-chain-broken"></i> <?php _e('Build Interrupt', 'wpflipwall'); ?></div>
				<b><?php _e('The current build has experienced an issue.', 'wpflipwall'); ?></b><br/>
			
				<i><?php _e('Please try the process again.', 'wpflipwall'); ?></i><br/><br/>
				  
				<input type="button" class="button" value="<?php _e('Try Again', 'wpflipwall'); ?>" onclick="window.location = 'admin.php?page=flipwall'" />
				<fieldset>
					<legend><b><i class="fa fa-exclamation"></i> <?php _e('Details', 'wpflipwall'); ?></b></legend>
					<div class="dup-msg-error-area">
						<div id="dup-msg-error-response-status">
							<span class="label"><?php _e("Server Status:", 'wpflipwall'); ?></span>
							<span class="data"></span>
						</div>
						<div id="dup-msg-error-response-text">
							<span class="label"><?php _e("Error Message:", 'wpflipwall'); ?></span><br/>
							<span class="data"></span>
						</div>
					</div>
				</fieldset><br/>
				...
				<div id="dup-logs">
					<div style="font-weight:bold">
						<a href='javascript:void(0)' onclick='Flipwall.OpenLogWindow()'> <?php _e('Package Log', 'wpflipwall');?> </a> &nbsp; | &nbsp;
						<a href='admin.php?page=flipwall-support' target="support"> <?php _e('Support', 'wpflipwall');?> </a>
					</div> 
					<br/>
				</div>
...
jQuery(document).ready(function($) {
	...
	*	Timeout (10000000 = 166 minutes)  */
	Flipwall.Pack.Create = function() {
		
		var data = {action : 'FLIPWALL_package_build'}
		...
		$.ajax({
			...
			success:    function(data) { 
				...
				//Wire Up Downloads
				$('#dup-btn-installer').on("click", {name: InstallURL }, Flipwall.Pack.DownloadFile  );
				$('#dup-btn-archive').on("click",   {name: ArchiveURL }, Flipwall.Pack.DownloadFile  );
