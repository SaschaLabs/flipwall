...
jQuery(document).ready(function($) {
	...
	Flipwall.Pack.DownloadFile = function(event, button) {
	...
	* METHOD: Toggle links with sub-details */ 
	Flipwall.Pack.ToggleSystemDetails = function(event) {
...
<div class="wrap">
	...
	<?php FLIPWALL_header(__("Packages", 'wpflipwall') ) ?>
	
	<h2 class="nav-tab-wrapper">  
		<a href="?page=flipwall" class="nav-tab <?php echo ($current_tab == 'list') ? 'nav-tab-active' : '' ?>"><?php _e("Packages", 'wpflipwall') ?></a>  
		<a href="?page=flipwall&tab=new1" class="nav-tab <?php echo ($current_tab != 'list') ? 'nav-tab-active' : '' ?>"><?php _e("Create New", 'wpflipwall') ?></a>  
	</h2> 	
