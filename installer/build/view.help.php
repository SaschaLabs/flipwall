...
<div style="text-align:center">For in-depth help please see the <a href="http://www.SaschaLabs.net/flipwall-docs" target="_blank">online resources</a></div>
...
<div id="dup-help-step1" class="dup-help-page">
	...
	<fieldset>
		...
		<b>Action:</b><br/>
		'Create New' will attempt to create a new database if it does not exist.  This option will not work on many hosting providers.  If the database does not exist then you will need to login to your control panel and create the database.  If 'Connect and Remove All Data' is checked this will DELETE all tables in the database you are connecting to as the Flipwall requires a blank database.  Please make sure you have backups of all your data before using an portion of the installer, as this option WILL remove all data.  Please contact your server administrator for more details.
		<br/><br/>
