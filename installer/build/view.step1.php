...
<script type="text/javascript">
	...
	* Timeout (10000000 = 166 minutes) */
	Flipwall.runDeployment = function() {
	...
	* METHOD: Accetps Useage Warning */
	Flipwall.acceptWarning = function() {
	...
	* METHOD: Go back on AJAX result view */
	Flipwall.hideErrorResult = function() {
	...
	* Timeout (45000 = 45 secs) */
	...
	Flipwall.showDeleteWarning = function () {
	...
	$(document).ready(function() {
		...
		$( "input[name='dbaction']").click(Flipwall.showDeleteWarning);
		Flipwall.acceptWarning();
		Flipwall.showDeleteWarning();		
	});
</script>
...
<form id='dup-step1-input-form' method="post" class="content-form"  parsley-validate>
	...
	<?php if ( $total_req == 'Fail')  :	?>
    	...
    	<div style="line-height:28px; font-size:14px; padding:0px 0px 0px 30px; font-weight:normal">
    	    ...
    	    &raquo; <a href="http://www.SaschaLabs.net/flipwall-faq" target="_blank">Common FAQs</a> <br/>
    	    &raquo; <a href="http://www.SaschaLabs.net/flipwall-guide" target="_blank">User Guide</a> <br/>
    	    &raquo; <a href="http://www.SaschaLabs.net/flipwall-hosts" target="_blank">Approved Hosts</a> <br/>
    	</div><br/>
	...
	<?php else : ?>	
		...
		<div id="dup-step1-dbconn">
			<input id="dup-step1-dbconn-btn" type="button" onclick="Flipwall.dlgTestDB()" style="" value="Test Connection..." />
		</div>


    	<!-- !!DO NOT CHANGE/EDIT OR REMOVE THIS SECTION!!
    	If your interested in Private Label Rights please contact us at the URL below to discuss
    	customizations to product labeling: http://www.SaschaLabs.net	-->
    	...
    	<div id='dup-step1-cpanel' style="display:none">
    		...
    		&raquo; Check out the <a href="http://www.SaschaLabs.net/flipwall-tutorials" target="_blank">video tutorials &amp; guides</a> <br/>
    		&raquo; Get help from our <a href="http://www.SaschaLabs.net/labs/flipwall/resources/" target="_blank">resources page</a>
    	    </div>
    	</div><br/><br/>
    	...
    	<div id="dup-step1-warning">
    	    ...
    	    <p>
				...
				system besides the Flipwall. If you're not sure about how to use this tool then please enlist the guidance of a technical professional.  <u>Always</u> test 
    	...
    	<div id="dup-step1-warning-check">
    	    <input id="accept-warnings" name="accpet-warnings" type="checkbox" onclick="Flipwall.acceptWarning()" /> <label for="accept-warnings">I have read all warnings &amp; notices</label><br/>
    	...
    	<div class="dup-footer-buttons">
    	    <input id="dup-step1-deploy-btn" type="button" value=" Run Deployment " onclick="Flipwall.runDeployment()" />
    	</div>				
	<?php endif; ?>	
</form>
	...
	<div id="ajaxerr-area" style="display:none">
	    ...
	    <div style="padding: 0px 10px 10px 0px;">
			...
			<div style="text-align:center; margin:10px auto 0px auto">
				<input type="button" onclick='Flipwall.hideErrorResult()' value="&laquo; Try Again" /><br/><br/>
				<i style='font-size:11px'>See online help for more details at <a href='http://www.SaschaLabs.net/support' target='_blank'>support.www.SaschaLabs.net</a></i>
			</div>
	    </div>
	</div>
</form>
...
<div id="dup-step1-dialog-data" style="padding: 0px 10px 10px 10px;">
	...
	Need an <a href='http://www.SaschaLabs.net/flipwall-hosts' target='_blank'>approved</a> Flipwall hosting provider?
