...
<script type="text/javascript">	
	...
	* METHOD: Posts to page to remove install files */	
	Flipwall.removeInstallerFiles = function(package_name) {
		...
		if (confirm(msg)) {
			var nurl = '<?php echo rtrim($_POST['url_new'], "/"); ?>/wp-admin/admin.php?page=flipwall-tools&tab=cleanup&action=installer&package=' + package_name;
...
<form id='dup-step3-input-form' method="post" class="content-form" style="line-height:20px">
	...
	<table class="dup-step3-final-step">
		...
		<tr>
			<td>4. <a href="javascript:void(0)" onclick="Flipwall.removeInstallerFiles('<?php echo $_POST['package_name'] ?>')">File Cleanup</a></td>
	...
	<div class='dup-step3-connect'>
		Please consider <a href='http://www.SaschaLabs.net/partner/' target='_blank'>Partnering or a Donation</a>! <br/>
		<a href="javascript:void(0)" onclick="Flipwall.dlgTips()">Troubleshoot</a> | 
		<a href='http://support.www.SaschaLabs.net/knowledgebase.php' target='_blank'>FAQs</a> | 
		<a href='http://www.SaschaLabs.net/flipwall' target='_blank'>Support</a>
	</div><br/>
</form>
...
<div id="dup-step3-dialog" title="Troubleshooting Tips" style="display:none">
	<div style="padding: 0px 10px 10px 10px;">		
		...
		<ul>
			<li>Use an <a href='http://www.SaschaLabs.net/flipwall-hosts' target='_blank'>approved hosting provider</a></li>
