...
<script type="text/javascript">
	...
	* METHOD: Returns the windows active url */
	Flipwall.getNewURL = function(id) {
	...
	* METHOD: Go back on AJAX result view */
	Flipwall.hideErrorResult2 = function() {
	...
	$(document).ready(function() {
		Flipwall.getNewURL('url_new');
		Flipwall.getNewURL('siteurl');
...
<form id='dup-step2-input-form' method="post" class="content-form">
	...
	<table class="table-inputs-step2">
		<tr valign="top">
			...
			<td>
				...
				<a href="javascript:Flipwall.editOldURL()" id="edit_url_old" style="font-size:12px">edit</a>		
			</td>
		</tr>
		<tr valign="top">
			<td>Path</td>
			<td>
				...
				<a href="javascript:Flipwall.editOldPath()" id="edit_path_old" style="font-size:12px">edit</a>		
			</td>
		</tr>
	</table>
	...
	<table class="table-inputs-step2">		
		<tr>
			...
			<td>
				...
				<a href="javascript:Flipwall.getNewURL('url_new')" style="font-size:12px">get</a>
			</td>
		</tr>
		<tr>
			<td>Path</td>
		...
		<table style="width: 100%;">
			<tr>
				...
				<td>
					...
					<a href="javascript:Flipwall.getNewURL('siteurl')" style="font-size:12px">get</a><br/>
				</td>
			</tr>
		</table><br/>
	...
	<div class="dup-footer-buttons">
		<input id="dup-step2-next" type="button" value=" Run Update " onclick="Flipwall.runUpdate()"  />
	</div>	
</form>
	...
	<div id="ajaxerr-area" style="display:none">
		...
		<div style="padding: 0px 10px 10px 10px;">
			...
			<div style="text-align:center; margin:10px auto 0px auto">
				<input type="button" onclick='Flipwall.hideErrorResult2()' value="&laquo; Try Again" /><br/><br/>
