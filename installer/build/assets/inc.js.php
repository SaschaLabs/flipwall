...
<script type="text/javascript">
	...
	Flipwall.showProgressBar = function () {
		Flipwall.animateProgressBar('progress-bar');
		$('#ajaxerr-area').hide();
		$('#progress-area').show();
	}
	Flipwall.hideProgressBar = function () {
		$('#progress-area').hide(100);
		$('#ajaxerr-area').fadeIn(400);
	}
	Flipwall.animateProgressBar = function(id) {
		//Create Progress Bar
		var $mainbar   = $("#" + id);
	...
	Flipwall.toggleMetaBox = function() {
	...
	$(document).ready(function() {
		...
		$('div.dup-box div.dup-box-title').each(function() { 
			...
			$title.click(Flipwall.toggleMetaBox); 
