<?php
/*
  Copyright 2011-14 Sascha Slusche  www.SaschaLabs.net
...
<?php if (false) : ?>
    ...
    <html>
        ...
        <body>
            ...
            <p>Flipwall requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned off.</p>
        </body>
    </html>
<?php endif; ?> 
...
$GLOBALS['FW_FLIPWALL_VERSION'] = '%fwrite_FLIPWALL_version%';
...
//CONSTANTS
define("FLIPWALL_INIT", 1); 
define("FLIPWALL_SSDIR_NAME", 'wp-snapshots');  //This should match FLIPWALL_SSDIR_NAME in flipwall.php
...
<head>
	...
	<title>Wordpress Flipwall</title>
	@@INC.LIBS.CSS.PHP@@	
	@@INC.CSS.PHP@@	
	@@INC.LIBS.JS.PHP@@
	@@INC.JS.PHP@@
		...
		<tr>
			...
			<td style="white-space:nowrap; text-align:right">
				<select id="dup-hlp-lnk">
					...
					<option value="http://www.SaschaLabs.net/flipwall-docs">&raquo; Knowledge Base</option>
					<option value="http://www.SaschaLabs.net/flipwall-guide">&raquo; User Guide</option>
					<option value="http://www.SaschaLabs.net/flipwall-faq">&raquo; Common FAQs</option>
					<option value="http://www.SaschaLabs.net/flipwall-hosts">&raquo; Approved Hosts</option>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td style="white-space:nowrap">
				...
				<i style='font-size:11px; color:#999'>
					version: <?php echo $GLOBALS['FW_FLIPWALL_VERSION'] ?>&nbsp;&nbsp;<a href="installer.php?help=1" target="_blank">[Help]</a>
				</i> &nbsp;
